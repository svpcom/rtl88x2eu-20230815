...
#include "../hal_halmac.h"	/* GET_RX_DESC_XXX_8822E() */
#include "rtl8822e.h"
...
static const struct hw_port_reg port_cfg[] = {
	/*port 0*/
	{
	.net_type = (REG_CR_8822E + 2),
	.net_type_shift = 0,
	.macaddr = REG_MACID_8822E,
	.bssid = REG_BSSID_8822E,
	.bcn_ctl = REG_BCN_CTRL_8822E,
	.tsf_rst = REG_DUAL_TSF_RST,
	.tsf_rst_bit = BIT_TSFTR_RST_8822E,
	.bcn_space = REG_MBSSID_BCN_SPACE_8822E,
	.bcn_space_shift = 0,
	.bcn_space_mask = 0xffff,
	.ps_aid = REG_BCN_PSR_RPT_8822E,
	.ta = REG_TRANSMIT_ADDRSS_0_8822E,
	},
	/*port 1*/
	{
	.net_type = (REG_CR_8822E + 2),
	.net_type_shift = 2,
	.macaddr = REG_MACID1_8822E,
	.bssid = REG_BSSID1_8822E,
	.bcn_ctl = REG_BCN_CTRL_CLINT0_8822E,
	.tsf_rst = REG_DUAL_TSF_RST,
	.tsf_rst_bit = BIT_TSFTR_CLI0_RST_8822E,
	.bcn_space = REG_MBSSID_BCN_SPACE_8822E,
	.bcn_space_shift = 16,
	.bcn_space_mask = 0xfff,
	.ps_aid = REG_BCN_PSR_RPT1_8822E,
	.ta = REG_TRANSMIT_ADDRSS_1_8822E,
	},
	/*port 2*/
	{
	.net_type =  REG_CR_EXT_8822E,
	.net_type_shift = 0,
	.macaddr = REG_MACID2_8822E,
	.bssid = REG_BSSID2_8822E,
	.bcn_ctl = REG_BCN_CTRL_CLINT1_8822E,
	.tsf_rst = REG_DUAL_TSF_RST,
	.tsf_rst_bit = BIT_TSFTR_CLI1_RST_8822E,
	.bcn_space = REG_MBSSID_BCN_SPACE2_8822E,
	.bcn_space_shift = 0,
	.bcn_space_mask = 0xfff,
	.ps_aid = REG_BCN_PSR_RPT2_8822E,
	.ta = REG_TRANSMIT_ADDRSS_2_8822E,
	},
	/*port 3*/
	{
	.net_type =  REG_CR_EXT_8822E,
	.net_type_shift = 2,
	.macaddr = REG_MACID3_8822E,
	.bssid = REG_BSSID3_8822E,
	.bcn_ctl = REG_BCN_CTRL_CLINT2_8822E,
	.tsf_rst = REG_DUAL_TSF_RST,
	.tsf_rst_bit = BIT_TSFTR_CLI2_RST_8822E,
	.bcn_space = REG_MBSSID_BCN_SPACE2_8822E,
	.bcn_space_shift = 16,
	.bcn_space_mask = 0xfff,
	.ps_aid = REG_BCN_PSR_RPT3_8822E,
	.ta = REG_TRANSMIT_ADDRSS_3_8822E,
	},
	/*port 4*/
	{
	.net_type =  REG_CR_EXT_8822E,
	.net_type_shift = 4,
	.macaddr = REG_MACID4_8822E,
	.bssid = REG_BSSID4_8822E,
	.bcn_ctl = REG_BCN_CTRL_CLINT3_8822E,
	.tsf_rst = REG_DUAL_TSF_RST,
	.tsf_rst_bit = BIT_TSFTR_CLI3_RST_8822E,
	.bcn_space = REG_MBSSID_BCN_SPACE3_8822E,
	.bcn_space_shift = 0,
	.bcn_space_mask = 0xfff,
	.ps_aid = REG_BCN_PSR_RPT4_8822E,
	.ta = REG_TRANSMIT_ADDRSS_4_8822E,
	},
};
...
static void read_chip_version(PADAPTER adapter)
{
	...
	value32 = rtw_read32(adapter, REG_SYS_CFG1_8822E);
	hal->version_id.ICType = CHIP_8822E;
	hal->version_id.ChipType = ((value32 & BIT_RTL_ID_8822E) ? TEST_CHIP : NORMAL_CHIP);
	hal->version_id.CUTVersion = BIT_GET_CHIP_VER_8822E(value32);
	hal->version_id.VendorType = BIT_GET_VENDOR_ID_8822E(value32);
	...
	hal->version_id.RFType = ((value32 & BIT_RF_TYPE_ID_8822E) ? RF_TYPE_2T2R : RF_TYPE_1T1R);

	/* refer to sd7 code base*/
	hal->RegulatorMode = ((value32 & BIT_INTERNAL_EXTERNAL_SWR_8822E) ? RT_LDO_REGULATOR : RT_SWITCHING_REGULATOR);

	value32 = rtw_read32(adapter, REG_SYS_STATUS1_8822E);
	hal->version_id.ROMVer = BIT_GET_RF_RL_ID_8822E(value32);

	/* For multi-function consideration. */
	hal->MultiFunc = RT_MULTI_FUNC_NONE;
	value32 = rtw_read32(adapter, REG_WL_BT_PWR_CTRL_8822E);
	hal->MultiFunc |= ((value32 & BIT_WL_FUNC_EN_8822E) ? RT_MULTI_FUNC_WIFI : 0);
	hal->MultiFunc |= ((value32 & BIT_BT_FUNC_EN_8822E) ? RT_MULTI_FUNC_BT : 0);
	hal->PolarityCtl = ((value32 & BIT_WL_HWPDN_SL_8822E) ? RT_POLARITY_HIGH_ACT : RT_POLARITY_LOW_ACT);
...
static void Hal_EfuseParseEEPROMVer(PADAPTER adapter, u8 *map, u8 mapvalid)
{
	...
	if (_TRUE == mapvalid)
		hal->EEPROMVersion = map[EEPROM_VERSION_8822E];
	else
		hal->EEPROMVersion = 1;
...
{
	PHAL_DATA_TYPE hal = GET_HAL_DATA(adapter);
	u8 tpt_mode = (map[EEPROM_TX_PWR_CALIBRATE_RATE_8822E] & 0xF0) >> 4;
	int ret = _FAIL;
...
parse_tpt_mode_done:
	...
	if ((_TRUE == mapvalid) && (map[EEPROM_RF_BOARD_OPTION_8822E] != 0xFF))
		hal->EEPROMRegulatory = map[EEPROM_RF_BOARD_OPTION_8822E] & 0x3; /* bit0~1 */
	else
...
static void Hal_EfuseParseBoardType(PADAPTER adapter, u8 *map, u8 mapvalid)
{
	...
	if ((_TRUE == mapvalid) && (map[EEPROM_RF_BOARD_OPTION_8822E] != 0xFF))
		hal->InterfaceSel = (map[EEPROM_RF_BOARD_OPTION_8822E] & 0xE0) >> 5;
	else
...
static void Hal_EfuseParseBTCoexistInfo(PADAPTER adapter, u8 *map, u8 mapvalid)
{
	...
	if ((_TRUE == mapvalid) && (map[EEPROM_RF_BOARD_OPTION_8822E] != 0xFF)) {
		/* 0xc1[7:5] = 0x01 */
		if (((map[EEPROM_RF_BOARD_OPTION_8822E] & 0xe0) >> 5) == 0x01)
	...
	hal->EEPROMBluetoothType = BT_RTL8822E;

	setting = map[EEPROM_RF_BT_SETTING_8822E];
...
static void Hal_EfuseParseChnlPlan(PADAPTER adapter, u8 *map, u8 autoloadfail)
{
	hal_com_config_channel_plan(
		adapter,
		map ? &map[EEPROM_COUNTRY_CODE_8822E] : NULL,
		map ? map[EEPROM_ChannelPlan_8822E] : 0xFF,
		RTW_CHPLAN_6G_NULL,
		autoloadfail
	);
}
...
#define GET_XCAP_VALUE_B9_8822E(x) (x & 0x7F)
#define GET_XCAP_VALUE_110_8822E(x) (x & 0x7F)
#define GET_XCAP_VALUE_111_8822E(x) ((x & 0x7F00) >> 8)
#define EFUSE_XCAP_VALID_CHK_B9_8822E(x) \
	(!(GET_XCAP_VALUE_B9_8822E(x) == 0x7F))
#define EFUSE_XCAP_VALID_CHK_110_8822E(x) \
	(!((GET_XCAP_VALUE_110_8822E(x) == EEPROM_Default_CrystalCap_110_8822E) || (GET_XCAP_VALUE_110_8822E(x) == 0x7F)))
#define EFUSE_XCAP_VALID_CHK_111_8822E(x) \
	(!((GET_XCAP_VALUE_111_8822E(x) == EEPROM_Default_CrystalCap_111_8822E) || (GET_XCAP_VALUE_111_8822E(x) == 0x7F)))
static s16 hal_efuse_search_xtal_cap(PADAPTER adapter, u8 h_xcap_b9, u16 f_xcap_110_111, u8 f_xcap_b9)
{
	enum {
		XCAP_SRC_H_EFUSE_B9_8822E = 0,
		XCAP_SRC_F_EFUSE_110_8822E,
		XCAP_SRC_F_EFUSE_B9_8822E,
		XCAP_SRC_8822E_MAX
	};

	const char *const xcap_src_8822e_str[XCAP_SRC_8822E_MAX] = {
		"XCAP_SRC_H_EFUSE_B9",
	...
	s8 xcap_src_8822e[XCAP_SRC_8822E_MAX] =
		{XCAP_SRC_F_EFUSE_B9_8822E, XCAP_SRC_F_EFUSE_110_8822E, XCAP_SRC_H_EFUSE_B9_8822E};
	...
	for (i = 0; i < XCAP_SRC_8822E_MAX; i++) {
		switch (xcap_src_8822e[i]) {
		case XCAP_SRC_H_EFUSE_B9_8822E:
			if (EFUSE_XCAP_VALID_CHK_B9_8822E(h_xcap_b9)) {
				xcap_value = ((GET_XCAP_VALUE_B9_8822E(h_xcap_b9) << 8) | GET_XCAP_VALUE_B9_8822E(h_xcap_b9));
				xcap_found = XCAP_SRC_H_EFUSE_B9_8822E;
			}
			break;
		case XCAP_SRC_F_EFUSE_110_8822E:
			if ((EFUSE_XCAP_VALID_CHK_110_8822E(f_xcap_110_111 )) && (EFUSE_XCAP_VALID_CHK_111_8822E(f_xcap_110_111 ))) {
				xcap_value = (f_xcap_110_111 & 0x7F7F);
				xcap_found = XCAP_SRC_F_EFUSE_110_8822E;
			}
			break;
		case XCAP_SRC_F_EFUSE_B9_8822E:
			if (EFUSE_XCAP_VALID_CHK_B9_8822E(f_xcap_b9)) {
				xcap_value = ((GET_XCAP_VALUE_B9_8822E(f_xcap_b9) << 8) | GET_XCAP_VALUE_B9_8822E(f_xcap_b9));
				xcap_found = XCAP_SRC_F_EFUSE_B9_8822E;
			}
			break;
		case -1:
			break;
	...
	u16 f_xcap_110_111, u8 f_xcap_b9, u8 mapvalid)
{
	...
	if (mapvalid == _FALSE) {
		hal->crystal_cap = EEPROM_Default_CrystalCap_110_8822E;
		goto exit;
	}
	...
	if (adapter->registrypriv.rtw_8822c_xcap_overwrite == 1) {
		...
		if (xcap_value != -1) {
			if (xcap_value != (h_xcap_110_111 & 0x7F7F)) {
				...
				rtw_efuse_map_write(adapter, EEPROM_XTAL_110_8822E, 2, (u8*)&xcap_value_to_h_efuse);
				RTW_INFO("update crystal_cap = 0x%02X into hw efuse!\n", xcap_value);
			}

			hal->crystal_cap = GET_XCAP_VALUE_110_8822E(xcap_value);
		}
		else {
			if ((EFUSE_XCAP_VALID_CHK_110_8822E(h_xcap_110_111)) && (EFUSE_XCAP_VALID_CHK_111_8822E(h_xcap_110_111)))
				hal->crystal_cap = GET_XCAP_VALUE_110_8822E(h_xcap_110_111);
			else
				hal->crystal_cap = EEPROM_Default_CrystalCap_110_8822E;
		}
	}
...
static void Hal_EfuseParseXtal(PADAPTER adapter, u8 *map, u8 mapvalid)
{
	...
	if ((_TRUE == mapvalid) && map[EEPROM_XTAL_B9_8822E] != 0xFF)
		hal->crystal_cap = map[EEPROM_XTAL_B9_8822E];
	else
		hal->crystal_cap = EEPROM_Default_CrystalCap_B9_8822E;
...
static void Hal_EfuseParseThermalMeter(PADAPTER adapter, u8 *map, u8 mapvalid)
{
	...
	if ((_TRUE == mapvalid) && (map[EEPROM_THERMAL_METER_A_8822E] != 0xFF) \
		&& (map[EEPROM_THERMAL_METER_B_8822E] != 0xFF)) {
		/* suggested by James@RF */
		u8 eeprom_thermal_meter_a = map[EEPROM_THERMAL_METER_A_8822E];
		u8 eeprom_thermal_meter_b = map[EEPROM_THERMAL_METER_B_8822E];
...
{
	PHAL_DATA_TYPE hal = GET_HAL_DATA(adapter);
	u8 trx_path_bmp = map[EEPROM_RF_ANTENNA_OPT_8822E];
	...
	case 0x22: /* 1T1R - TX:B,	RX:B */
		...
		RTW_INFO("EEPROM efuse[0x%x]=0x%02x is valid\n"
			, EEPROM_RF_ANTENNA_OPT_8822E, trx_path_bmp);
		break;
	default:
...
static void Hal_EfuseParseCustomerID(PADAPTER adapter, u8 *map, u8 mapvalid)
{
	...
	if (_TRUE == mapvalid)
		hal->EEPROMCustomerID = map[EEPROM_CustomID_8822E];
	else
...
static void hal_ReadPAType(PADAPTER adapter, u8 *map, u8 mapvalid)
{
	...
	if (mapvalid) {
		...
		if (GetRegAmplifierType2G(adapter) == 0) {
			hal->PAType_2G = ReadLE1Byte(&map[EEPROM_2G_5G_PA_TYPE_8822E]);
			hal->LNAType_2G = ReadLE1Byte(&map[EEPROM_2G_LNA_TYPE_GAIN_SEL_AB_8822E]);
		...
		if (GetRegAmplifierType5G(adapter) == 0) {
			hal->PAType_5G = ReadLE1Byte(&map[EEPROM_2G_5G_PA_TYPE_8822E]);
			hal->LNAType_5G = ReadLE1Byte(&map[EEPROM_5G_LNA_TYPE_GAIN_SEL_AB_8822E]);
...
{
	PHAL_DATA_TYPE hal = GET_HAL_DATA(adapter);
	u8 extTypePA_2G_A = (map[EEPROM_2G_LNA_TYPE_GAIN_SEL_AB_8822E] & BIT2) >> 2;
	u8 extTypePA_2G_B = (map[EEPROM_2G_LNA_TYPE_GAIN_SEL_AB_8822E] & BIT6) >> 6;
	u8 extTypePA_5G_A = (map[EEPROM_5G_LNA_TYPE_GAIN_SEL_AB_8822E] & BIT2) >> 2;
	u8 extTypePA_5G_B = (map[EEPROM_5G_LNA_TYPE_GAIN_SEL_AB_8822E] & BIT6) >> 6;
	u8 extTypeLNA_2G_A = (map[EEPROM_2G_LNA_TYPE_GAIN_SEL_AB_8822E] & (BIT1 | BIT0)) >> 0;
	u8 extTypeLNA_2G_B = (map[EEPROM_2G_LNA_TYPE_GAIN_SEL_AB_8822E] & (BIT5 | BIT4)) >> 4;
	u8 extTypeLNA_5G_A = (map[EEPROM_5G_LNA_TYPE_GAIN_SEL_AB_8822E] & (BIT1 | BIT0)) >> 0;
	u8 extTypeLNA_5G_B = (map[EEPROM_5G_LNA_TYPE_GAIN_SEL_AB_8822E] & (BIT5 | BIT4)) >> 4;
...
static u8 Hal_ReadRFEType(PADAPTER adapter, u8 *map, u8 mapvalid)
{
	...
	if (mapvalid) {
		/* check efuse map */
		hal->rfe_type = ReadLE1Byte(&map[EEPROM_RFE_OPTION_8822E]);
	...
	RTW_ERR("cmd: insmod rtl8822ex.ko rtw_RFE_type=<rfe_type>\n\n");
...
static void Hal_ReadUsbModeSwitch(PADAPTER adapter, u8 *map, u8 mapvalid)
{
	...
	if (_TRUE == mapvalid)
		...
		hal->EEPROMUsbSwitch = (map[EEPROM_USB_MODE_8822EU] & BIT7) >> 7;
	else
...
static void hal_read_usb_pid_vid(PADAPTER adapter, u8 *map, u8 mapvalid)
{
	...
	if (_TRUE == mapvalid) {
		/* VID, PID */
		hal->EEPROMVID = ReadLE2Byte(&map[EEPROM_VID_8822EU]);
		hal->EEPROMPID = ReadLE2Byte(&map[EEPROM_PID_8822EU]);
	} else {
 ...
 */
u8 rtl8822e_read_efuse(PADAPTER adapter)
{
	PHAL_DATA_TYPE hal;
	u8 val8;
	u8 *efuse_map = NULL;
	...
	/*
	 * In 8822E, bautoload_fail_flag is used to present eFuse map is valid
	...
	h_efuse_xcap_110_111 = ((efuse_map[EEPROM_XTAL_111_8822E] << 8) | efuse_map[EEPROM_XTAL_110_8822E]);
#endif
	...
	if (check_phy_efuse_tx_power_info_valid(adapter) == _FALSE) {
		if (Hal_readPGDataFromConfigFile(adapter) != _SUCCESS)
			...
			f_efuse_xcap_b9 = efuse_map[EEPROM_XTAL_B9_8822E];
...
void rtl8822e_run_thread(PADAPTER adapter)
{
}

void rtl8822e_cancel_thread(PADAPTER adapter)
{
}
...
static void beacon_function_enable(PADAPTER adapter, u8 Enable, u8 Linked)
{
	...
	if (adapter->hw_port == HW_PORT1) {
		bcn_ctrl_reg = REG_BCN_CTRL_CLINT0_8822E;
		val8 = BIT_CLI0_DIS_TSF_UDT_8822E | BIT_CLI0_EN_BCN_FUNCTION_8822E;
	}
#endif
...
static void xmit_status_check(PADAPTER p)
{
	...
	txdma_status = rtw_read32(p, REG_TXDMA_STATUS_8822E);
...
static void check_rx_count(PADAPTER p)
{
	...
	rxff_cnt_orig_r = rtw_read32(p, REG_RXFF_PTR_V1_8822E) & 0x3ffff;
	rxff_cnt_orig_w = rtw_read32(p, REG_RXFF_WTR_V1_8822E) & 0x3ffff;
	rtw_msleep_os(10);

	for (i = 0; i < DETECT_CNT; i++) {
		rxff_cnt_r = rtw_read32(p, REG_RXFF_PTR_V1_8822E) & 0x3ffff;
		rxff_cnt_w = rtw_read32(p, REG_RXFF_WTR_V1_8822E) & 0x3ffff;
		rtw_msleep_os(10);
...
static void linked_status_check(PADAPTER p)
{
	...
	rx_dma_status = rtw_read32(p, REG_RXDMA_STATUS_8822E);
...
static void set_opmode_monitor(PADAPTER adapter)
{
	...
	/* Receive all type */
	tmp_32bit = BIT_AAP_8822E | BIT_APP_PHYSTS_8822E;

	if (ndev->type == ARPHRD_IEEE80211_RADIOTAP) {
		/* Append FCS */
		tmp_32bit |= BIT_APP_FCS_8822E;
	}
	...
	tmp_8bit = rtw_read8(adapter, REG_RX_DRVINFO_SZ_8822E);
	rtw_write8(adapter, REG_RX_DRVINFO_SZ_8822E, (tmp_8bit | 0x80));

	/* Receive all data frames */
	mon->known_rxfilter = 1;
	mon->rxfilter0 = rtw_read16(adapter, REG_RXFLTMAP0_8822E);
	mon->rxfilter1 = rtw_read16(adapter, REG_RXFLTMAP1_8822E);
	mon->rxfilter2 = rtw_read16(adapter, REG_RXFLTMAP2_8822E);
	rtw_write16(adapter, REG_RXFLTMAP0_8822E, 0xFFFF);
	rtw_write16(adapter, REG_RXFLTMAP1_8822E, 0xFFFF);
	rtw_write16(adapter, REG_RXFLTMAP2_8822E, 0xFFFF);
...
static void set_opmode_port0(PADAPTER adapter, u8 mode)
{
	...
	case _HW_STATE_STATION_:
		if (!is_tx_bcn) {
			...
			UpdateInterruptMask8822EE(adapter, 0, 0, RT_BCN_INT_MASKS, 0);
#endif /* CONFIG_PCI_HCI */
		}

		/* disable beacon function */
		val8 = BIT_DIS_TSF_UDT_8822E | BIT_EN_BCN_FUNCTION_8822E;
		rtw_write8(adapter, REG_BCN_CTRL_8822E, val8);

		/* disable atim wnd(only for Port0) */
		val8 = rtw_read8(adapter, REG_DIS_ATIM_8822E);
		val8 |= BIT_DIS_ATIM_ROOT_8822E;
		rtw_write8(adapter, REG_DIS_ATIM_8822E, val8);
		break;
	...
	case _HW_STATE_AP_:
#ifdef CONFIG_PCI_HCI
		UpdateInterruptMask8822EE(adapter, RT_BCN_INT_MASKS, 0, 0, 0);
#endif /* CONFIG_PCI_HCI */
		 ...
		 * Reg REG_FWHW_TXQ_CTRL_8822E [2] = 1
		 * Reg REG_BCN_CTRL_8822E[3][5] = 1
		 * Enable ATIM
		 * Enable HW seq for BCN
		 */
		/* enable TX BCN report */
		/* disable RX BCN report */
		val8 = rtw_read8(adapter, REG_FWHW_TXQ_CTRL_8822E);
		val8 |= BIT_EN_BCN_TRXRPT_V1_8822E;
		rtw_write8(adapter, REG_FWHW_TXQ_CTRL_8822E, val8);

		/* enable BCN0 Function */
		val8 = rtw_read8(adapter, REG_BCN_CTRL_8822E);
		val8 |= BIT_EN_BCN_FUNCTION_8822E | BIT_DIS_TSF_UDT_8822E | BIT_P0_EN_TXBCN_RPT_8822E;
		val8 &= (~BIT_P0_EN_RXBCN_RPT_8822E);
		rtw_write8(adapter, REG_BCN_CTRL_8822E, val8);
		...
		/* Enable HW seq for BCN
			...
			According TX desc
		*/
		rtw_write8(adapter, REG_DUMMY_PAGE4_V1_8822E, 0x01);

		/* enable to rx data frame */
		rtw_write16(adapter, REG_RXFLTMAP2_8822E, 0xFFFF);
		/* enable to rx ps-poll */
		val16 = rtw_read16(adapter, REG_RXFLTMAP1_8822E);
		val16 |= BIT_CTRLFLT10EN_8822E;
		rtw_write16(adapter, REG_RXFLTMAP1_8822E, val16);

		/* Beacon Control related register for first time */
		rtw_write8(adapter, REG_BCNDMATIM_8822E, 0x02); /* 2ms */

		rtw_write8(adapter, REG_ATIMWND_8822E, 0x0c); /* 12ms */


		rtw_write16(adapter, REG_TSFTR_SYN_OFFSET_8822E, 0x7fff); /* +32767 (~32ms) */

		/* reset TSF */
		rtw_write8(adapter, REG_DUAL_TSF_RST_8822E, BIT_TSFTR_RST_8822E);

		/* SW_BCN_SEL - Port0 */
		rtw_hal_set_hwreg(adapter, HW_VAR_DL_BCN_SEL, NULL);

		/* select BCN on port 0 */
		val8 = rtw_read8(adapter, REG_CCK_CHECK_8822E);
		val8 &= ~BIT_BCN_PORT_SEL_8822E;
		rtw_write8(adapter, REG_CCK_CHECK_8822E, val8);
		break;
	}
}
...
static void hw_var_set_opmode(PADAPTER adapter, u8 mode)
{
	...
	if (isMonitor == _TRUE) {
		...
		if (backup->known_rcr) {
			...
			if (!!(backup->rcr &= BIT_APP_PHYSTS_8822E))
				rtw_halmac_config_rx_info(adapter_to_dvobj(adapter),
		...
		if (backup->known_rxfilter) {
			...
			rtw_write16(adapter, REG_RXFLTMAP0_8822E, backup->rxfilter0);
			rtw_write16(adapter, REG_RXFLTMAP1_8822E, backup->rxfilter1);
			rtw_write16(adapter, REG_RXFLTMAP2_8822E, backup->rxfilter2);
		}
#endif /* CONFIG_WIFI_MONITOR */
		isMonitor = _FALSE;
	}
	...
	/* clear crc bit */
	if (rtw_hal_rcr_check(adapter, BIT_ACRC32_8822E))
		rtw_hal_rcr_clear(adapter, BIT_ACRC32_8822E);
...
static void hw_var_set_bcn_func(PADAPTER adapter, u8 enable)
{
	...
	if (enable) {
		...
		switch (adapter->hw_port) {
		case HW_PORT0:
			val8 =  BIT_EN_BCN_FUNCTION_8822E | BIT_P0_EN_TXBCN_RPT_8822E;
			hw_bcn_ctrl_clr(adapter, get_hw_port(adapter), BIT_P0_EN_RXBCN_RPT_8822E);
			break;
#ifdef CONFIG_CONCURRENT_MODE
		case HW_PORT1:
			val8 =  BIT_CLI0_EN_BCN_FUNCTION_8822E;
			hw_bcn_ctrl_clr(adapter, get_hw_port(adapter), BIT_CLI0_EN_RXBCN_RPT_8822E);
			break;
		case HW_PORT2:
			val8 =  BIT_CLI1_EN_BCN_FUNCTION_8822E;
			hw_bcn_ctrl_clr(adapter, get_hw_port(adapter), BIT_CLI1_EN_RXBCN_RPT_8822E);
			break;
		case HW_PORT3:
			val8 =  BIT_CLI2_EN_BCN_FUNCTION_8822E;
			hw_bcn_ctrl_clr(adapter, get_hw_port(adapter), BIT_CLI2_EN_RXBCN_RPT_8822E);
			break;
		case HW_PORT4:
			val8 =  BIT_CLI3_EN_BCN_FUNCTION_8822E;
			hw_bcn_ctrl_clr(adapter, get_hw_port(adapter), BIT_CLI3_EN_RXBCN_RPT_8822E);
			break;
#endif /* CONFIG_CONCURRENT_MODE */
		default:
		...
		case HW_PORT0:
			...
			if (GET_HAL_DATA(adapter)->EEPROMBluetoothCoexist)
				val8 = BIT_P0_EN_TXBCN_RPT_8822E;
...
static void hw_var_set_mlme_disconnect(PADAPTER adapter)
{
	...
	if (rtw_mi_check_status(adapter, MI_LINKED) == _FALSE)
		...
		rtw_write16(adapter, REG_RXFLTMAP2_8822E, 0);

#ifdef CONFIG_CONCURRENT_MODE
	if (adapter->hw_port == HW_PORT1) {
		/* reset TSF1(CLINT0) */
		rtw_write8(adapter, REG_DUAL_TSF_RST_8822E, BIT_TSFTR_CLI0_RST_8822E);
	...
	if (MSTATE_STA_LD_NUM(&mstate) == 0 && MSTATE_STA_LG_NUM(&mstate) == 0)
		rtl8822e_rx_tsf_addr_filter_config(adapter, 0);
...
static void hw_var_set_mlme_sitesurvey(PADAPTER adapter, u8 enable)
{
	...
	if (enable) {
		...
		rtw_write16(adapter, REG_RXFLTMAP2_8822E, value_rxfltmap2);
...
static void hw_var_set_mlme_join(PADAPTER adapter, u8 type)
{
	...
	if (type == 0) {
		...
		/*
		 * for 8822E, must enable BCN function if BIT_CBSSID_BCN_8822E(bit 7) of REG_RCR(0x608) is enable to recv BSSID bcn
		 */
		hw_var_set_bcn_func(adapter, _TRUE);

		/* update TSF only BSSID match for station mode */
		rtl8822e_rx_tsf_addr_filter_config(adapter, BIT_CHK_TSF_EN_8822E | BIT_CHK_TSF_CBSSID_8822E);
		#ifdef CONFIG_CLIENT_PORT_CFG
		...
		if (rtw_mi_check_status(adapter, MI_LINKED) == _FALSE)
			rtw_write16(adapter, REG_RXFLTMAP2_8822E, 0x00);
		...
		if (rtw_mi_get_ap_num(adapter) || rtw_mi_get_mesh_num(adapter)) {
			...
			val8 = BIT_TSFTR_RST_8822E | BIT_TSFTR_CLI0_RST_8822E;
			rtw_write8(adapter, REG_DUAL_TSF_RST_8822E, val8);
		}
		#ifdef CONFIG_CLIENT_PORT_CFG
		if (MLME_IS_STA(adapter))
		...
		if (rtw_mi_get_ap_num(adapter) || rtw_mi_get_mesh_num(adapter)) {
			...
			/* reset TSF 1/2 after resume_tx_beacon */
			rtw_write8(adapter, REG_DUAL_TSF_RST_8822E, BIT_TSFTR_RST_8822E | BIT_TSFTR_CLI0_RST_8822E);
		}
	}

	val16 = BIT_LRL_8822E(RetryLimit) | BIT_SRL_8822E(RetryLimit);
	rtw_write16(adapter, REG_RETRY_LIMIT_8822E, val16);
#else /* !CONFIG_CONCURRENT_MODE */
	if (type == 0) {
		/* prepare to join */
		...
		/*
		 * for 8822E, must enable BCN function if BIT_CBSSID_BCN_8822E(bit 7) of REG_RCR(0x608) is enabled to recv BSSID bcn
		 */
		hw_var_set_bcn_func(adapter, _TRUE);
...
static void hw_var_set_acm_ctrl(PADAPTER adapter, u8 ctrl)
{
	...
	if (ctrl) {
		hwctrl |= BIT_ACMHWEN_8822E;

		if (ctrl & BIT(1)) /* BE */
			hwctrl |= BIT_BEQ_ACM_EN_8822E;
		else
			hwctrl &= (~BIT_BEQ_ACM_EN_8822E);

		if (ctrl & BIT(2)) /* VI */
			hwctrl |= BIT_VIQ_ACM_EN_8822E;
		else
			hwctrl &= (~BIT_VIQ_ACM_EN_8822E);

		if (ctrl & BIT(3)) /* VO */
			hwctrl |= BIT_VOQ_ACM_EN_8822E;
		else
			hwctrl &= (~BIT_VOQ_ACM_EN_8822E);
	}

	RTW_INFO("[HW_VAR_ACM_CTRL] Write 0x%02X\n", hwctrl);
	rtw_write8(adapter, REG_ACMHWCTRL_8822E, hwctrl);
}
...
static void hw_var_set_sec_dk_cfg(PADAPTER adapter, u8 enable)
{
	...
	u8 reg_scr = rtw_read8(adapter, REG_SECCFG_8822E);

	if (enable) {
		/* Enable default key related setting */
		reg_scr |= BIT_TXBCUSEDK_8822E;
		if (sec->dot11AuthAlgrthm != dot11AuthAlgrthm_8021X)
			reg_scr |= BIT_RXUHUSEDK_8822E | BIT_TXUHUSEDK_8822E;
	} else {
		/* Disable default key related setting */
		reg_scr &= ~(BIT_RXBCUSEDK_8822E | BIT_TXBCUSEDK_8822E | BIT_RXUHUSEDK_8822E | BIT_TXUHUSEDK_8822E);
	}

	rtw_write8(adapter, REG_SECCFG_8822E, reg_scr);

	RTW_INFO("%s: [HW_VAR_SEC_DK_CFG] 0x%x=0x%08x\n", __FUNCTION__,
		 REG_SECCFG_8822E, rtw_read32(adapter, REG_SECCFG_8822E));
}
...
static void hw_var_set_bcn_valid(PADAPTER adapter)
{
	...
	val8 = rtw_read8(adapter, REG_FIFOPAGE_CTRL_2_8822E + 1);
	val8 = val8 | BIT(7);
	rtw_write8(adapter, REG_FIFOPAGE_CTRL_2_8822E + 1, val8);
}
...
static void hw_var_set_ack_preamble(PADAPTER adapter, u8 bShortPreamble)
{
	...
	val8 = rtw_read8(adapter, REG_WMAC_TRXPTCL_CTL_8822E + 2);
	val8 |= BIT(4) | BIT(5);
	...
	rtw_write8(adapter, REG_WMAC_TRXPTCL_CTL_8822E + 2, val8);
}
...
void hw_var_set_dl_rsvd_page(PADAPTER adapter, u8 mstatus)
{
	...
	if (mstatus == RT_MEDIA_CONNECT) {
		...
		/* We should set AID, correct TSF, HW seq enable before set JoinBssReport to Fw in 8822E. */
		rtw_write16(adapter, port_cfg[hw_port].ps_aid, (0xF800 | pmlmeinfo->aid));

		/* Enable SW TX beacon */
		v8 = rtw_read8(adapter, REG_CR_8822E + 1);
		restore[0] = v8;
		v8 |= (BIT_ENSWBCN_8822E >> 8);
		rtw_write8(adapter, REG_CR_8822E + 1, v8);
		...
		val8 = rtw_read8(adapter, REG_BCN_CTRL_8822E);
		restore[1] = val8;
		/* val8 &= ~BIT_EN_BCN_FUNCTION_8822E; */
		restore[2] = rtw_read8(adapter, REG_FWHW_TXQ_CTRL_8822E + 2);
		if (restore[2] & BIT(6)) {
			rtw_write8(adapter, REG_FWHW_TXQ_CTRL_8822E + 2,
				(restore[2] & ~BIT(6)));
		}
		val8 |= BIT_DIS_TSF_UDT_8822E;
		rtw_write8(adapter, REG_BCN_CTRL_8822E, val8);
		...
		RegFwHwTxQCtrl = rtw_read8(adapter, REG_FWHW_TXQ_CTRL_8822E + 2);
		...
		rtw_write8(adapter, REG_FWHW_TXQ_CTRL_8822E + 2, RegFwHwTxQCtrl);
#endif
		...
		rtw_write8(adapter, REG_FWHW_TXQ_CTRL_8822E + 2, restore[2]);
...
u8 rtl8822e_sethwreg(PADAPTER adapter, u8 variable, u8 *val)
{
	PHAL_DATA_TYPE hal = GET_HAL_DATA(adapter);
	u8 ret = _SUCCESS;
	u8 val8;
...
*/
	...
	case HW_VAR_TXPAUSE:
		rtw_write8(adapter, REG_TXPAUSE_8822E, *val);
		break;
	...
	case HW_VAR_RCR:
		ret = rtl8822e_rcr_config(adapter, *((u32 *)val));
		break;

	case HW_VAR_SLOT_TIME:
		rtw_write8(adapter, REG_SLOT_8822E, *val);
		break;

	case HW_VAR_RESP_SIFS:
		/* RESP_SIFS for CCK */
		rtw_write8(adapter, REG_RESP_SIFS_CCK_8822E, 0x08);
		rtw_write8(adapter, REG_RESP_SIFS_CCK_8822E + 1, 0x08);
		/* RESP_SIFS for OFDM */
		rtw_write8(adapter, REG_RESP_SIFS_OFDM_8822E, 0x0a);
		rtw_write8(adapter, REG_RESP_SIFS_OFDM_8822E + 1, 0x0a);
		break;
...
*/
	...
	case HW_VAR_CAM_INVALID_ALL:
		val32 = BIT_SECCAM_POLLING_8822E | BIT_SECCAM_CLR_8822E;
		rtw_write32(adapter, REG_CAMCMD_8822E, val32);
		break;

	case HW_VAR_AC_PARAM_VO:
		rtw_write32(adapter, REG_EDCA_VO_PARAM_8822E, *(u32 *)val);
		break;

	case HW_VAR_AC_PARAM_VI:
		rtw_write32(adapter, REG_EDCA_VI_PARAM_8822E, *(u32 *)val);
		break;

	case HW_VAR_AC_PARAM_BE:
		hal->ac_param_be = *(u32 *)val;
		rtw_write32(adapter, REG_EDCA_BE_PARAM_8822E, *(u32 *)val);
		break;

	case HW_VAR_AC_PARAM_BK:
		rtw_write32(adapter, REG_EDCA_BK_PARAM_8822E, *(u32 *)val);
		break;
...
*/
	...
	case HW_VAR_AMPDU_FACTOR: {
		...
		rtw_write32(adapter, REG_AMPDU_MAX_LENGTH_HT_8822E, AMPDULen);
	}
	break;
...
*/
	case HW_VAR_H2C_FW_PWRMODE:
		rtl8822e_set_FwPwrMode_cmd(adapter, *val);
		break;

	case HW_VAR_H2C_FW_PWRMODE_RFON_CTRL:
		rtl8822e_set_FwPwrMode_rfon_ctrl_cmd(adapter, *val);
		break;
...
*/
...
#ifdef CONFIG_WOWLAN
		rtl8822e_set_fw_pwrmode_inips_cmd_wowlan(adapter, *val);
#endif /* CONFIG_WOWLAN */
		break;
	...
	case HW_VAR_DL_RSVD_PAGE:
		...
		if (check_fwstate(&adapter->mlmepriv, WIFI_AP_STATE) == _TRUE)
			rtl8822e_download_BTCoex_AP_mode_rsvd_page(adapter);
#endif
		break;
#ifdef CONFIG_P2P_PS
...
*/
	case HW_VAR_FIFO_CLEARN_UP: {
		...
		/* pause tx */
		rtw_write8(adapter, REG_TXPAUSE_8822E, 0xff);

		/* keep hw sn */
		if (adapter->xmitpriv.hw_ssn_seq_no == 1)
			reg_hw_ssn = REG_HW_SEQ1_8822E;
		else if (adapter->xmitpriv.hw_ssn_seq_no == 2)
			reg_hw_ssn = REG_HW_SEQ2_8822E;
		else if (adapter->xmitpriv.hw_ssn_seq_no == 3)
			reg_hw_ssn = REG_HW_SEQ3_8822E;
		else
			reg_hw_ssn = REG_HW_SEQ0_8822E;

		adapter->xmitpriv.nqos_ssn = rtw_read16(adapter, reg_hw_ssn);

		if (pwrpriv->bkeepfwalive != _TRUE) {
			/* RX DMA stop */
			val32 = rtw_read32(adapter, REG_RXPKT_NUM_8822E);
			val32 |= BIT_RW_RELEASE_EN;
			rtw_write32(adapter, REG_RXPKT_NUM_8822E, val32);
			do {
				val32 = rtw_read32(adapter, REG_RXPKT_NUM_8822E);
				val32 &= BIT_RXDMA_IDLE_8822E;
				if (val32)
					break;
	...
	case HW_VAR_CHECK_TXBUF: {
		...
		rtylmtorg = rtw_read16(adapter, REG_RETRY_LIMIT_8822E);
		...
		rtw_write16(adapter, REG_RETRY_LIMIT_8822E, rtylmtorg);
	}
	break;
/*
...
#define HAL_NAV_UPPER_UNIT	128	/* micro-second */
		...
		rtw_write8(adapter, REG_NAV_CTRL_8822E + 2, (u8)usNavUpper);
	}
	break;
...
*/
	...
	case HW_VAR_SOUNDING_ENTER:
		rtl8822e_phy_bf_enter(adapter, (struct sta_info*)val);
		break;

	case HW_VAR_SOUNDING_LEAVE:
		rtl8822e_phy_bf_leave(adapter, val);
		break;
/*
...
*/
	case HW_VAR_SOUNDING_STATUS:
		rtl8822e_phy_bf_sounding_status(adapter, *val);
		break;
/*
...
*/
	case HW_VAR_SOUNDING_SET_GID_TABLE:
		rtl8822e_phy_bf_set_gid_table(adapter, (struct beamformer_entry*)val);
		break;
...
static void dump_mac_qinfo(void *sel, _adapter *adapter)
{
	...
	q0_info = rtw_read32(adapter, REG_Q0_INFO_8822E);
	q1_info = rtw_read32(adapter, REG_Q1_INFO_8822E);
	q2_info = rtw_read32(adapter, REG_Q2_INFO_8822E);
	q3_info = rtw_read32(adapter, REG_Q3_INFO_8822E);
	q4_info = rtw_read32(adapter, REG_Q4_INFO_8822E);
	q5_info = rtw_read32(adapter, REG_Q5_INFO_8822E);
	q6_info = rtw_read32(adapter, REG_Q6_INFO_8822E);
	q7_info = rtw_read32(adapter, REG_Q7_INFO_8822E);
	mg_q_info = rtw_read32(adapter, REG_MGQ_INFO_8822E);
	hi_q_info = rtw_read32(adapter, REG_HIQ_INFO_8822E);
	bcn_q_info = rtw_read16(adapter, REG_BCNQ_INFO_8822E);

	q0_q1_info = rtw_read32(adapter, REG_Q0_Q1_INFO_8822E);
	q2_q3_info = rtw_read32(adapter, REG_Q2_Q3_INFO_8822E);
	q4_q5_info = rtw_read32(adapter, REG_Q4_Q5_INFO_8822E);
	q6_q7_info = rtw_read32(adapter, REG_Q6_Q7_INFO_8822E);
	mg_hi_q_info = rtw_read32(adapter, REG_MGQ_HIQ_INFO_8822E);
	cmd_bcn_q_info = rtw_read32(adapter, REG_CMDQ_BCNQ_INFO_8822E);
...
static void dump_mac_txfifo(void *sel, _adapter *adapter)
{
	...
	hpq = rtw_read32(adapter, REG_FIFOPAGE_INFO_1_8822E);
	lpq = rtw_read32(adapter, REG_FIFOPAGE_INFO_2_8822E);
	npq = rtw_read32(adapter, REG_FIFOPAGE_INFO_3_8822E);
	epq = rtw_read32(adapter, REG_FIFOPAGE_INFO_4_8822E);
	pubq = rtw_read32(adapter, REG_FIFOPAGE_INFO_5_8822E);
...
void rtl8822e_read_wmmedca_reg(PADAPTER adapter, u16 *vo_params, u16 *vi_params, u16 *be_params, u16 *bk_params)
{
	u8 vo_reg_params[4];
	u8 vi_reg_params[4];
	u8 be_reg_params[4];
	...
	rtl8822e_gethwreg(adapter, HW_VAR_AC_PARAM_VO, vo_reg_params);
	rtl8822e_gethwreg(adapter, HW_VAR_AC_PARAM_VI, vi_reg_params);
	rtl8822e_gethwreg(adapter, HW_VAR_AC_PARAM_BE, be_reg_params);
	rtl8822e_gethwreg(adapter, HW_VAR_AC_PARAM_BK, bk_reg_params);
...
void rtl8822e_gethwreg(PADAPTER adapter, u8 variable, u8 *val)
{
	u8 val8;
	u16 val16;
	u32 val32;
...
*/
	case HW_VAR_TXPAUSE:
		*val = rtw_read8(adapter, REG_TXPAUSE_8822E);
		break;
/*
	case HW_VAR_BCN_FUNC:
	case HW_VAR_MLME_DISCONNECT:
		...
		if (rtw_is_surprise_removed(adapter) ||
			...
			*val = _TRUE;
			...
			if (adapter_to_pwrctl(adapter)->wowlan_mode == _TRUE)
				val32 &= (BIT_UC_MD_EN_8822E | BIT_BC_MD_EN_8822E);
			else
				val32 &= (BIT_UC_MD_EN_8822E | BIT_BC_MD_EN_8822E | BIT_TIM_PARSER_EN_8822E);
...
*/
	case HW_VAR_SYS_CLKR:
		*val = rtw_read8(adapter, REG_SYS_CLK_CTRL_8822E);
		break;
/*
	case HW_VAR_NAV_UPPER:
	case HW_VAR_RPT_TIMER_SETTING:
...
*/
	case HW_VAR_CHK_HI_QUEUE_EMPTY:
		val16 = rtw_read16(adapter, REG_TXPKT_EMPTY_8822E);
		*val = (val16 & BIT_HQQ_EMPTY_8822E) ? _TRUE : _FALSE;
		break;
	case HW_VAR_CHK_MGQ_CPU_EMPTY:
		val16 = rtw_read16(adapter, REG_TXPKT_EMPTY_8822E);
		*val = (val16 & BIT_MGQ_CPU_EMPTY_8822E) ? _TRUE : _FALSE;
		break;
/*
 ...
 */
u8 rtl8822e_sethaldefvar(PADAPTER adapter, HAL_DEF_VARIABLE variable, void *pval)
{
	u8 bResult;
...
void rtl8822e_ra_info_dump(_adapter *padapter, void *sel)
{
	u8 mac_id;
 ...
 */
u8 rtl8822e_gethaldefvar(PADAPTER adapter, HAL_DEF_VARIABLE variable, void *pval)
{
	u8 bResult;
	u8 val8 = 0;
	u32 val32 = 0;
...
*/
	...
	case HAL_DEF_RX_PACKET_OFFSET:
		val32 = rtl8822e_get_rx_desc_size(adapter);
		val8 = rtl8822e_get_rx_drv_info_size(adapter);
		*((u32 *)pval) = val32 + val8;
		break;
/*
	case HAL_DEF_RX_DMA_SZ_WOW:
...
*/
	...
	case HW_VAR_MAX_RX_AMPDU_FACTOR:
		/* 8822E RX FIFO is 24KB */
		*(HT_CAP_AMPDU_FACTOR *)pval = MAX_AMPDU_FACTOR_16K;
		break;

	case HW_DEF_RA_INFO_DUMP:
		rtl8822e_ra_info_dump(adapter, pval);
		break;
/*
	case HAL_DEF_DBG_DUMP_TXPKT:
	case HAL_DEF_TX_PAGE_SIZE:
...
void rtl8822e_fill_txdesc_sectype(struct pkt_attrib *pattrib, u8 *ptxdesc)
{
	if (!pattrib->bswenc) {
		...
		case _TKIP_:
		case _TKIP_WTMIC_:
			SET_TX_DESC_SEC_TYPE_8822E(ptxdesc, 0x1);
			break;
#ifdef CONFIG_WAPI_SUPPORT
		case _SMS4_:
			SET_TX_DESC_SEC_TYPE_8822E(ptxdesc, 0x2);
			break;
#endif
		case _AES_:
			SET_TX_DESC_SEC_TYPE_8822E(ptxdesc, 0x3);
			break;
		case _CCMP_256_:
		case _GCMP_:
		case _GCMP_256_:
		...
		case _NO_PRIVACY_:
		default:
			SET_TX_DESC_SEC_TYPE_8822E(ptxdesc, 0x0);
			break;
		}
	}
}

void rtl8822e_fill_txdesc_vcs(PADAPTER adapter, struct pkt_attrib *pattrib, u8 *ptxdesc)
{
	struct mlme_ext_priv *pmlmeext = &adapter->mlmeextpriv;
	struct mlme_ext_info *pmlmeinfo = &(pmlmeext->mlmext_info);
	...
	if (pattrib->vcs_mode) {
		...
		case RTS_CTS:
			SET_TX_DESC_RTSEN_8822E(ptxdesc, 1);
			break;
		case CTS_TO_SELF:
			SET_TX_DESC_CTS2SELF_8822E(ptxdesc, 1);
			break;
		case NONE_VCS:
		default:
			break;
		...
		if (pmlmeinfo->preamble_mode == PREAMBLE_SHORT)
			SET_TX_DESC_RTS_SHORT_8822E(ptxdesc, 1);

		/* RTS Rate=24M */
		SET_TX_DESC_RTSRATE_8822E(ptxdesc, 0x8);

		/* compatibility for MCC consideration, use pmlmeext->cur_channel */
		if (pmlmeext->cur_channel > 14)
			/* RTS retry to rate OFDM 6M for 5G */
			SET_TX_DESC_RTS_RTY_LOWEST_RATE_8822E(ptxdesc, 4);
		else
			/* RTS retry to rate CCK 1M for 2.4G */
			SET_TX_DESC_RTS_RTY_LOWEST_RATE_8822E(ptxdesc, 0);
	}
}

u8 rtl8822e_bw_mapping(PADAPTER adapter, struct pkt_attrib *pattrib)
{
...
u8 rtl8822e_sc_mapping(PADAPTER adapter, struct pkt_attrib *pattrib)
{
...
void rtl8822e_fill_txdesc_phy(PADAPTER adapter, struct pkt_attrib *pattrib, u8 *ptxdesc)
{
	if (pattrib->ht_en) {
		/* Set Bandwidth and sub-channel settings. */
		SET_TX_DESC_DATA_BW_8822E(ptxdesc, rtl8822e_bw_mapping(adapter, pattrib));
		SET_TX_DESC_DATA_SC_8822E(ptxdesc, rtl8822e_sc_mapping(adapter, pattrib));
	}
}

/**
 * rtl8822e_fill_txdesc_tx_rate() - Set rate in tx description
 ...
 */
static void rtl8822e_fill_txdesc_tx_rate(struct _ADAPTER *adapter,
				...
				u8 rate, u8 shrt, u8 fallback, u8 *desc)
{
	...
	SET_TX_DESC_USE_RATE_8822E(desc, 1);
	SET_TX_DESC_DATARATE_8822E(desc, rate);
	SET_TX_DESC_DATA_SHORT_8822E(desc, shrt);
	SET_TX_DESC_DISDATAFB_8822E(desc, disfb);

	/* HT MCS rate can't support bandwidth higher than 40MHz */
	bw = GET_TX_DESC_DATA_BW_8822E(desc);
	if (((rate >= DESC_RATEMCS0) && (rate <= DESC_RATEMCS31)) && (bw > 1)) {
		...
		rtl8822e_fill_txdesc_phy(adapter, attrib, desc);
	}
}

void rtl8822e_fill_txdesc_force_bmc_camid(struct pkt_attrib *pattrib, u8 *ptxdesc)
{
	if ((pattrib->encrypt > 0) && (!pattrib->bswenc)
	    && (pattrib->bmc_camid != INVALID_SEC_MAC_CAM_ID)) {
		SET_TX_DESC_EN_DESC_ID_8822E(ptxdesc, 1);
		SET_TX_DESC_MACID_8822E(ptxdesc, pattrib->bmc_camid);
	}
}

void rtl8822e_fill_txdesc_bmc_tx_rate(struct pkt_attrib *pattrib, u8 *ptxdesc)
{
	SET_TX_DESC_USE_RATE_8822E(ptxdesc, 1);
	SET_TX_DESC_DATARATE_8822E(ptxdesc, MRateToHwRate(pattrib->rate));
 ...
 */
void rtl8822e_fill_txdesc_bf(struct xmit_frame *frame, u8 *desc)
{
	...
	SET_TX_DESC_G_ID_8822E(desc, attrib->txbf_g_id);
	SET_TX_DESC_P_AID_8822E(desc, attrib->txbf_p_aid);
	
        //RTW_INFO("+%s p_aid=%u g_id=%u\n",__FUNCTION__, attrib->txbf_p_aid, attrib->txbf_g_id); 
        
	SET_TX_DESC_MU_DATARATE_8822E(desc, init_rate);
	/*SET_TX_DESC_MU_RC_8822E(desc, 0);*/

	/* Force to disable STBC when txbf is enabled */
	if (attrib->txbf_p_aid && attrib->stbc)
		SET_TX_DESC_DATA_STBC_8822E(desc, 0);
#else
        return;
#endif /* CONFIG_BEAMFORMING */
}
 ...
 */
void rtl8822e_fill_txdesc_mgnt_bf(struct xmit_frame *frame, u8 *desc)
{
#if defined(CONFIG_BEAMFORMING) || defined(CONFIG_BEAMFORMING_MONITOR)
	...
	/*SET_TX_DESC_TXPKTSIZE_8822E(desc, pattrib->last_txcmdsz);*/
	/*SET_TX_DESC_OFFSET_8822E(desc, HALMAC_TX_DESC_SIZE_8822E);*/
	SET_TX_DESC_DISRTSFB_8822E(desc, 1);
	SET_TX_DESC_DISDATAFB(desc, 1);
	/*SET_TX_DESC_SW_SEQ_8822E(desc, pattrib->seqnum);*/
	SET_TX_DESC_DATA_BW_8822E(desc, rtl8822e_bw_mapping(adapter, attrib));
	 ...
	 * MCS8 for HT
	 */
	SET_TX_DESC_DATARATE_8822E(desc, MRateToHwRate(attrib->rate));
	/*SET_TX_DESC_USE_RATE_8822E(desc, 1);*/
	/*SET_TX_DESC_MACID_8822E(desc, pattrib->mac_id);*/ /* ad-hoc mode */
	/*SET_TX_DESC_G_ID_8822E(desc, 63);*/
	/*
	 ...
	 */
	/*SET_TX_DESC_P_AID_8822E(desc, pattrib->txbf_p_aid);*/
	SET_TX_DESC_SND_PKT_SEL_8822E(desc, attrib->bf_pkt_type);
#else
        return;
#endif /* CONFIG_BEAMFORMING */
}

void rtl8822e_cal_txdesc_chksum(PADAPTER adapter, u8 *ptxdesc)
{
...
void rtl8822e_prepare_mp_txdesc(PADAPTER adapter, struct mp_priv *pmp_priv)
{
	u8 *desc;
	struct pkt_attrib *attrib;
	u32 pkt_size;
	...
	desc_size = rtl8822e_get_tx_desc_size(adapter);

	SET_TX_DESC_LS_8822E(desc, 1);
	SET_TX_DESC_TXPKTSIZE_8822E(desc, pkt_size);

	offset = desc_size;
	SET_TX_DESC_OFFSET_8822E(desc, offset);
#if defined(CONFIG_PCI_HCI)
	SET_TX_DESC_PKT_OFFSET_8822E(desc, 0); /* 8822EE pkt_offset is 0 */
#else
	SET_TX_DESC_PKT_OFFSET_8822E(desc, 1);
#endif

	if (bmcast)
		SET_TX_DESC_BMC_8822E(desc, 1);

	SET_TX_DESC_MACID_8822E(desc, attrib->mac_id);
	SET_TX_DESC_RATE_ID_8822E(desc, attrib->raid);
	SET_TX_DESC_QSEL_8822E(desc, attrib->qsel);

	if (pmp_priv->preamble)
		SET_TX_DESC_DATA_SHORT_8822E(desc, 1);

	if (!attrib->qos_en)
		SET_TX_DESC_EN_HWSEQ_8822E(desc, 1);
	else
		SET_TX_DESC_SW_SEQ_8822E(desc, attrib->seqnum);

	if (pmp_priv->bandwidth <= CHANNEL_WIDTH_160)
		SET_TX_DESC_DATA_BW_8822E(desc, pmp_priv->bandwidth);
	else {
		RTW_ERR("%s: unknown bandwidth %d, use 20M\n",
			 __FUNCTION__, pmp_priv->bandwidth);
		SET_TX_DESC_DATA_BW_8822E(desc, CHANNEL_WIDTH_20);
	}

	SET_TX_DESC_DISDATAFB_8822E(desc, 1);
	SET_TX_DESC_USE_RATE_8822E(desc, 1);
	SET_TX_DESC_DATARATE_8822E(desc, pmp_priv->rateidx);
}
...
static void fill_default_txdesc(struct xmit_frame *pxmitframe, u8 *pbuf)
{
	...
	if (pxmitframe->frame_tag == DATA_FRAMETAG) {
		...
		SET_TX_DESC_MACID_8822E(pbuf, pattrib->mac_id);
		SET_TX_DESC_RATE_ID_8822E(pbuf, pattrib->raid);
		SET_TX_DESC_QSEL_8822E(pbuf, pattrib->qsel);
		SET_TX_DESC_SW_SEQ_8822E(pbuf, pattrib->seqnum);

		rtl8822e_fill_txdesc_sectype(pattrib, pbuf);
		rtl8822e_fill_txdesc_vcs(adapter, pattrib, pbuf);

		if (bmcst)
			rtl8822e_fill_txdesc_force_bmc_camid(pattrib, pbuf);
		...
		if ((pattrib->ether_type != 0x888e) &&
			...
			if (pattrib->ampdu_en == _TRUE) {
				SET_TX_DESC_AGG_EN_8822E(pbuf, 1);
				SET_TX_DESC_MAX_AGG_NUM_8822E(pbuf, 0x1F);
				SET_TX_DESC_AMPDU_DENSITY_8822E(pbuf, pattrib->ampdu_spacing);
			} else
				SET_TX_DESC_BK_8822E(pbuf, 1);

			rtl8822e_fill_txdesc_phy(adapter, pattrib, pbuf);

			/* compatibility for MCC consideration, use pmlmeext->cur_channel */
			if (!bmcst) {
				if (pmlmeext->cur_channel > 14)
					/* for 5G, OFDM 6M */
					SET_TX_DESC_DATA_RTY_LOWEST_RATE_8822E(pbuf, 4);
				else
					/* for 2.4G, CCK 1M */
					SET_TX_DESC_DATA_RTY_LOWEST_RATE_8822E(pbuf, 0);
			}

			if (hal->fw_ractrl == _FALSE)
				rtl8822e_fill_txdesc_tx_rate(adapter, pattrib,
					hal->INIDATA_RATE[pattrib->mac_id] & 0x7F,
					hal->INIDATA_RATE[pattrib->mac_id] & BIT(7) ? 1 : 0,
					1, pbuf);

			if (bmcst) {
				SET_TX_DESC_SW_DEFINE_8822E(pbuf, 0x01);
				rtl8822e_fill_txdesc_bmc_tx_rate(pattrib, pbuf);
			}
			...
			if (pattrib->ldpc)
				SET_TX_DESC_DATA_LDPC_8822E(pbuf, 1);
			if (pattrib->stbc)
				SET_TX_DESC_DATA_STBC_8822E(pbuf, 1);

#ifdef CONFIG_CMCC_TEST
			SET_TX_DESC_DATA_SHORT_8822E(pbuf, 1); /* use cck short premble */
#endif

#ifdef CONFIG_WMMPS_STA
			if (pattrib->trigger_frame)
				SET_TX_DESC_TRI_FRAME_8822E (pbuf, 1);
			...
			SET_TX_DESC_BK_8822E(pbuf, 1);
			SET_TX_DESC_USE_RATE_8822E(pbuf, 1);
			if (pmlmeinfo->preamble_mode == PREAMBLE_SHORT)
				SET_TX_DESC_DATA_SHORT_8822E(pbuf, 1);
#ifdef CONFIG_IP_R_MONITOR
			if((pattrib->ether_type == ETH_P_ARP) &&
				(IsSupportedTxOFDM(adapter->registrypriv.wireless_mode))) 
				SET_TX_DESC_DATARATE_8822E(pbuf, MRateToHwRate(IEEE80211_OFDM_RATE_6MB));
			 else
#endif/*CONFIG_IP_R_MONITOR*/
				SET_TX_DESC_DATARATE_8822E(pbuf, MRateToHwRate(pmlmeext->tx_rate));
		...
		if (pxmitframe->ack_report) {
			...
			SET_TX_DESC_SW_DEFINE_8822E(pbuf, (u8)(GET_PRIMARY_ADAPTER(adapter)->xmitpriv.seq_no));
		}
		...
		SET_TX_DESC_MBSSID_8822E(pbuf, pattrib->mbssid & 0xF);

		SET_TX_DESC_DATARATE_8822E(pbuf, MRateToHwRate(pattrib->rate));

		SET_TX_DESC_RTY_LMT_EN_8822E(pbuf, 1);
		if (pattrib->retry_ctrl == _TRUE)
			SET_TX_DESC_RTS_DATA_RTY_LMT_8822E(pbuf, 6);
		else
			SET_TX_DESC_RTS_DATA_RTY_LMT_8822E(pbuf, 12);

		rtl8822e_fill_txdesc_mgnt_bf(pxmitframe, pbuf);
	...
	SET_TX_DESC_TXPKTSIZE_8822E(pbuf, pattrib->last_txcmdsz);

	{
		...
		SET_TX_DESC_PKT_OFFSET_8822E(pbuf, pkt_offset);
		SET_TX_DESC_OFFSET_8822E(pbuf, offset);
#ifdef CONFIG_TCP_CSUM_OFFLOAD_TX
	if (pattrib->hw_csum == 1) {
		int offset = 48 + pkt_offset*8 + 24;

		SET_TX_DESC_OFFSET_8822E(pbuf, offset);
		SET_TX_DESC_CHK_EN_8822E(pbuf, 1);
		SET_TX_DESC_WHEADER_LEN_8822E(pbuf, (pattrib->hdrlen + pattrib->iv_len + XATTRIB_GET_MCTRL_LEN(pattrib))>>1);
	}
#endif
	}

	if (bmcst)
		SET_TX_DESC_BMC_8822E(pbuf, 1);
	 ...
	 */
	if (!pattrib->qos_en) {
		SET_TX_DESC_DISQSELSEQ_8822E(pbuf, 1);
		SET_TX_DESC_EN_HWSEQ_8822E(pbuf, 1);
		SET_TX_DESC_HW_SSN_SEL_8822E(pbuf, pattrib->hw_ssn_sel);
	}

	SET_TX_DESC_PORT_ID_8822E(pbuf, hw_port);
	SET_TX_DESC_MULTIPLE_PORT_8822E(pbuf, hw_port);
	...
	rtl8822e_fill_txdesc_bf(pxmitframe, pbuf);
}
 ...
 */
void rtl8822e_update_txdesc(struct xmit_frame *pxmitframe, u8 *pbuf)
{
	fill_default_txdesc(pxmitframe, pbuf);
	rtl8822e_cal_txdesc_chksum(pxmitframe->padapter, pbuf);
}
			     ...
			     u8 IsPsPoll, u8 IsBTQosNull, u8 bDataFrame)
{
	...
	SET_TX_DESC_LS_8822E(pDesc, 1);

	SET_TX_DESC_OFFSET_8822E(pDesc, desc_size);

	SET_TX_DESC_TXPKTSIZE_8822E(pDesc, BufferLen);
	SET_TX_DESC_QSEL_8822E(pDesc, QSLT_MGNT); /* Fixed queue of Mgnt queue */

	if (pmlmeext->cur_wireless_mode & WIRELESS_11B)
		SET_TX_DESC_RATE_ID_8822E(pDesc, RATEID_IDX_B);
	else
		SET_TX_DESC_RATE_ID_8822E(pDesc, RATEID_IDX_G);

	/* Set NAVUSEHDR to prevent Ps-poll AId filed to be changed to error vlaue by HW */
	if (_TRUE == IsPsPoll)
		SET_TX_DESC_NAVUSEHDR_8822E(pDesc, 1);
	else {
		SET_TX_DESC_DISQSELSEQ_8822E(pDesc, 1);
		SET_TX_DESC_EN_HWSEQ_8822E(pDesc, 1);
		SET_TX_DESC_HW_SSN_SEL_8822E(pDesc, pxmitpriv->hw_ssn_seq_no);/*pattrib->hw_ssn_sel*/
		SET_TX_DESC_EN_HWEXSEQ_8822E(pDesc, 0);
	}

	if (_TRUE == IsBTQosNull)
		SET_TX_DESC_BT_NULL_8822E(pDesc, 1);

	SET_TX_DESC_USE_RATE_8822E(pDesc, 1);
	SET_TX_DESC_DATARATE_8822E(pDesc, MRateToHwRate(pmlmeext->tx_rate));
	...
	if (IsPsPoll == _FALSE && IsBTQosNull == _FALSE && bDataFrame == _FALSE) {
		if (rtw_hal_check_mcc_status(adapter, MCC_STATUS_PROCESS_MCC_START_SETTING)) {
			...
			if (rty_num != 0) {
				SET_TX_DESC_RTY_LMT_EN_8822E(pDesc, 1);
				SET_TX_DESC_RTS_DATA_RTY_LMT_8822E(pDesc, rty_num);
			}
		}
	}
#endif
	...
	if (_TRUE == bDataFrame) {
		...
		switch (EncAlg) {
		case _NO_PRIVACY_:
			SET_TX_DESC_SEC_TYPE_8822E(pDesc, 0x0);
			break;
		case _WEP40_:
		case _WEP104_:
		case _TKIP_:
			SET_TX_DESC_SEC_TYPE_8822E(pDesc, 0x1);
			break;
		case _SMS4_:
			SET_TX_DESC_SEC_TYPE_8822E(pDesc, 0x2);
			break;
		case _AES_:
			SET_TX_DESC_SEC_TYPE_8822E(pDesc, 0x3);
			break;
		case _CCMP_256_:
		case _GCMP_:
		case _GCMP_256_:
	...
	SET_TX_DESC_PORT_ID_8822E(pDesc, hw_port);
	SET_TX_DESC_MULTIPLE_PORT_8822E(pDesc, hw_port);
#if defined(CONFIG_USB_HCI) || defined(CONFIG_SDIO_HCI) || defined(CONFIG_GSPI_HCI)
	/*
	 * USB interface drop packet if the checksum of descriptor isn't correct.
	 * Using this checksum can let hardware recovery from packet bulk out error (e.g. Cancel URC, Bulk out error.).
	 */
	rtl8822e_cal_txdesc_chksum(adapter, pDesc);
#endif
}

void rtl8822e_dbg_dump_tx_desc(PADAPTER adapter, int frame_tag, u8 *ptxdesc)
{
	u8 bDumpTxPkt;
	...
	/* 8822E TX SIZE = 48(HALMAC_TX_DESC_SIZE_8822E) */
...
/* xmit section */
void rtl8822e_init_xmit_priv(_adapter *adapter)
{
	struct xmit_priv *pxmitpriv = &adapter->xmitpriv;
...
void rtl8822e_rxdesc2attribute(struct rx_pkt_attrib *a, u8 *desc)
{
	/* initial value */
	...
	/* Get from RX DESC */
	a->pkt_len = (u16)GET_RX_DESC_PKT_LEN_8822E(desc);
	a->pkt_rpt_type = GET_RX_DESC_C2H_8822E(desc) ? C2H_PACKET : NORMAL_RX;

	if (a->pkt_rpt_type == NORMAL_RX) {
		a->crc_err = (u8)GET_RX_DESC_CRC32_8822E(desc);
		a->icv_err = (u8)GET_RX_DESC_ICV_ERR_8822E(desc);
		a->drvinfo_sz = (u8)GET_RX_DESC_DRV_INFO_SIZE_8822E(desc) << 3;
		a->encrypt = (u8)GET_RX_DESC_SECURITY_8822E(desc);
		a->qos = (u8)GET_RX_DESC_QOS_8822E(desc);
		a->shift_sz = (u8)GET_RX_DESC_SHIFT_8822E(desc);
		a->physt = (u8)GET_RX_DESC_PHYST_8822E(desc);
		a->bdecrypted = (u8)GET_RX_DESC_SWDEC_8822E(desc) ? 0 : 1;

		a->priority = (u8)GET_RX_DESC_TID_8822E(desc);
		a->amsdu = (u8)GET_RX_DESC_AMSDU_8822E(desc);
		a->mdata = (u8)GET_RX_DESC_MD_8822E(desc);
		a->mfrag = (u8)GET_RX_DESC_MF_8822E(desc);

		a->seq_num = (u16)GET_RX_DESC_SEQ_8822E(desc);
		a->frag_num = (u8)GET_RX_DESC_FRAG_8822E(desc);

		a->data_rate = (u8)GET_RX_DESC_RX_RATE_8822E(desc);
		a->ampdu = (u8)GET_RX_DESC_PAGGR_8822E(desc);
		a->ampdu_eof = (u8)GET_RX_DESC_RX_EOF_8822E(desc);
		a->ppdu_cnt = (u8)GET_RX_DESC_PPDU_CNT_8822E(desc);
		a->free_cnt = (u32)GET_RX_DESC_TSFL_8822E(desc);

#ifdef CONFIG_TCP_CSUM_OFFLOAD_RX
		/* RX TCP checksum offload related variables */
		a->csum_valid = (u8)GET_RX_DESC_CHK_VLD_8822E(desc);
		a->csum_err = (u8)GET_RX_DESC_CHKERR_8822E(desc);
#endif /* CONFIG_TCP_CSUM_OFFLOAD_RX */
	}
}

void rtl8822e_query_rx_desc(union recv_frame *precvframe, u8 *pdesc)
{
	rtl8822e_rxdesc2attribute(&precvframe->u.hdr.attrib, pdesc);
}

void rtl8822e_set_hal_ops(PADAPTER adapter)
{
	struct hal_com_data *hal;
	struct hal_ops *ops;
...
*/
	ops->read_adapter_info = rtl8822e_read_efuse;
	ops->hal_power_on = rtl8822e_power_on;
	ops->hal_power_off = rtl8822e_power_off;
	ops->hal_init = rtl8822e_init;
	ops->hal_deinit = rtl8822e_deinit;
	ops->dm_init = rtl8822e_phy_init_dm_priv;
	ops->dm_deinit = rtl8822e_phy_deinit_dm_priv;
...
#endif
*/
	ops->run_thread = rtl8822e_run_thread;
	ops->cancel_thread = rtl8822e_cancel_thread;
...
*/
	...
	/*** DM section ***/
	ops->set_chnl_bw_handler = rtl8822e_set_channel_bw;

	ops->set_tx_power_level_handler = rtl8822e_set_tx_power_level;
	ops->set_txpwr_done = rtl8822e_set_txpwr_done;
	ops->set_tx_power_index_handler = rtl8822e_set_tx_power_index;
	ops->get_tx_power_index_handler = hal_com_get_txpwr_idx;

	ops->hal_dm_watchdog = rtl8822e_phy_haldm_watchdog;

	ops->set_hw_reg_handler = rtl8822e_sethwreg;
	ops->GetHwRegHandler = rtl8822e_gethwreg;
	ops->get_hal_def_var_handler = rtl8822e_gethaldefvar;
	ops->SetHalDefVarHandler = rtl8822e_sethaldefvar;
...
*/
	ops->read_bbreg = rtl8822e_read_bb_reg;
	ops->write_bbreg = rtl8822e_write_bb_reg;
	ops->read_rfreg = rtl8822e_read_rf_reg;
	ops->write_rfreg = rtl8822e_write_rf_reg;
	ops->read_wmmedca_reg = rtl8822e_read_wmmedca_reg;
...
*/
	...
	ops->hal_notch_filter = rtl8822e_notch_filter_switch;
	ops->hal_mac_c2h_handler = rtl8822e_c2h_handler;
	ops->fill_h2c_cmd = rtl8822e_fillh2ccmd;
	ops->fill_fake_txdesc = fill_fake_txdesc;
	ops->fw_dl = rtl8822e_fw_dl;
...
*/
	...
	ops->init_mac_register = rtl8822e_phy_init_mac_register;
	ops->init_phy = rtl8822e_phy_init;
